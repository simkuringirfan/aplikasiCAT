                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="page-title">Daftar Hasil Ujian CAT Plus</h4>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                      <a href="/Ujian/tambahPenilaian/<?= $b['no_reg_ujian']; ?>" class="btn btn-warning-outline btn-circle waves-effect waves-light">
                                             <i class="far fa-edit"></i>
                                          </a>

                                          <form action="/Ujian/<?= $b['no_reg_ujian']; ?>;hasilUjianCatPlus" method="post" class="d-inline">
                                        <?= csrf_field(); ?> 
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary">Ya</button>
                                      ...
                                      <td><?= $b['nilai_total']; ?></td>
                                      <td><?= $b['nilai_tambah']; ?></td>
                                      <td><?= $b['detail_nilai_tambah']; ?></td>
                                      <td><?= $b['grade']; ?></td>
