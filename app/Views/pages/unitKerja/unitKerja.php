...
<?= $this->section('content'); ?>
                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <a href="/UnitKerja/createUnitKerja/"><button type="button" class="btn btn-primary waves-effect waves-light">Tambah Unit Kerja</button></a>
                                    ...
                                    <tr>
                                      ...
                                      <td><?= $b['update_date']; ?></td>
                                      <td>
                                          <a href="/UnitKerja/edit/<?= $b['id']; ?>" class="btn btn-warning-outline btn-circle waves-effect waves-light">
                                             <i class="far fa-edit"></i>
                                          </a>
                                          <form action="/UnitKerja/<?= $b['id']; ?>" method="post" class="d-inline">
                                        <?= csrf_field(); ?> 
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            Apakah anda yakin akan delete Id Unit Kerja <?= $b['id']; ?> dengan Unit Kerja
            <br><?= $b['unit_kerja']; ?>?
