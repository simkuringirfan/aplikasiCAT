  ...
  <body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <input type="text" id="jumlahSoal" name="jumlahSoal" value="<?= $config['jumlah_soal']; ?>" hidden>
            <input type="text" id="soalDijawab" name="soalDijawab" value="<?= $countJawab; ?>" hidden>
            <input type="text" id="sisaSoal" name="sisaSoal" value="<?= $config['jumlah_soal']-$countJawab; ?>" hidden>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <label for="waktuUjian" class="col-sm-6 col-form-label">Sisa Waktu Ujian : </label>
                            <p class="col-sm-6 col-form-label" id="waktuUjian"></p>
                        </div>
                    </form>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600"><label for="jumlahSoal" class="col-form-label">Jumlah Soal : <i class="col-sm-4 col-form-label"><?= $config['jumlah_soal']; ?></i></label></span>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600"><label for="soalDijawab" class="col-form-label">Soal Dijawab : <i class="col-sm-4 col-form-label"><?= $countJawab; ?></i></label></span>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600"><label for="sisaSoal" class="col-form-label">Sisa Soal : <i class="col-sm-4 col-form-label"><?= $config['jumlah_soal']-$countJawab; ?></i></label></span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Anda Sedang Ujian</h1>
                                                        ...
                                                        <form action="/Ujian/ujian/<?= $dataUjianBy['no_reg_ujian']; ?>;pindahPages" method="POST" enctype="multipart/form-data">
                                                         <?= csrf_field(); ?>                                                                                                                                                                                                         
                                                            ...
                                                            <?php if ($detailUjianSoal[$i]['jawab']!=null) :?>
                                                                <td><button type="submit" class="btn btn-success small"><?= $i+1 ?></button></td>
                                                            <?php else :?>
                                                                <td><button type="submit" class="btn btn-danger small"><?= $i+1 ?></button></td>
                                                            <?php endif; ?>                                                                  
                                                        </form>                                                        
                                                    <?php } ?>
                                                    </tr>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>3jayaCode &copy; AstaCode</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
